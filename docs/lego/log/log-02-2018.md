...
---
## 02/10 Tue Cloudy
Not too many Sunny days recently. Well, continue yesterday's work. I don't think I can easily find out why so many `/proc/memoinfo` open happened.I'm trying to enable the `flush_thread` in P's exec code.
